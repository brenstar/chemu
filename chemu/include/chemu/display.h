...
CHEMU_API void chemu_disp_clear(ChipDisplay *display);
...
// otherwise.
CHEMU_API bool chemu_disp_draw(ChipDisplay *display, ChipSprite sprite);

// Gets the state of a pixel at the given coordinates in the display.
CHEMU_API int chemu_disp_get(ChipDisplay *display, int x, int y);
